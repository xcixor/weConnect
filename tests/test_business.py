...
class TestBusinessCase(unittest.TestCase):
    ...
    def test_edit_business(self):
        ...
        self.mock_business.create_business(self.business_list)  
        res = self.mock_business.edit_business(self.business_list, Description='We no longer sell bananas', Location='Somewhere')
        self.assertIn('We no longer sell bananas', self.business_list[0]['Description'])
    ...
    def test_find_businesses_by_category(self):
        ...
        self.mock_business.create_business(self.business_list)  
        response = Business.get_businesses_by_category(self.business_list,'fruit vendors')
    ...
    def test_find_businesses_by_location(self):
        ...
        self.mock_business.create_business(self.business_list)                  
        response = Business.get_businesses_by_location(self.business_list, 'Kawangware')
        self.assertIn('James Barber', response[0]['Name'])
