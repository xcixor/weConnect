...
class TestBusinessCase(unittest.TestCase):
    ...
    def test_create_business(self):
        ...
        [{"Name":"James Barber", "Descrition":"We sell bananas", \
        "Location":"Kawangware", "Category":"fruit vendors"}])
    
    def test_cannot_create_duplicate_businesses(self):
        """Test app cannot duplicate business"""
        self.mock_business.create_business()
        another_biz = Business("james barber", "We sell bananas", \
        "Kawangware", "fruit vendors")
    ...
    def test_edit_business(self):
        ...
        response = self.mock_business.edit_business(Description=\
        'We no longer sell bananas')
        self.assertTrue(response)
        self.assertEqual(Business.get_all_businesses(), \
        [{"Name":"James Barber", "Description":"We no longer sell bananas", \
        "Location":"Kawangware", "Category":"fruit vendors"}])
    ...
    def test_find_event_by_id(self):
        ...
        "Descrition":"We sell bananas", "Location":"Kawangware", \
